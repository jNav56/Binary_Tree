...
public class BinarySearchTree<E extends Comparable<? super E>> {
    ...
    // Invert tree vertically
    private void invertTree(BSTNode<E> n) {
    	
    	if(n != null) {
    		BSTNode<E> temp = n.getLeft();
...
//    	// Size of tree
//    	g.drawString("Size: " + size(), 30, 85);
//    	
//    	// Height
//    	g.drawString("Height: " + height(), 30, 105);
//    	
//    	// Max
//    	g.drawString("Max: " + max(), 30, 125);
//    	
//    	// Min
//    	g.drawString("Min: " + min(), 30, 145);
    	
    	font = new Font("Verdana", Font.PLAIN, 12);
    	g.setFont(font);
    	g.setColor(Color.BLACK);
    	
    	drawTree(g, root, x, 20, 30, 30, 0);
    }
    
    public void drawTree(Graphics g, BSTNode<E> n, int x, int y, int length, int height, int line) {
    	if(n == null) {
    		return;
    	}
    	
    	drawTree(g, n.getRight(), x + 50, y + 60, length, height, 1);
    	
    	// Drawing line from node to parent
    	if(line == 1) {
    		g.drawLine(x + 15, y, x - 35, y - 30);
    	} else if(line == 2) {
    		g.drawLine(x + 15, y, x + 65, y - 30);
    	}
    	...
    	if(num < 10) {
    		...
    		g.drawString(n.getData() + "", x + 7, y + 18);
    	}
    	
    	drawTree(g, n.getLeft(), x - 50, y + 60, length, height, 2);
    }
